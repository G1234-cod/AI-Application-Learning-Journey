...
📁 **相关资源**：
- [提示词模板详解](./6.PromptTemplate总结)
- [聊天模板详解](./7.ChatPromptTemplate总结)
- [输出解析器详解](./8.返回值类型总结)
- [链式调用详解](./9.Chains知识总结)
...
![image-20260520225152628](./5.Model_整体流程及学习框架.assets/image-20260520225152628.png)
...
> 📖 **详细内容**：见 [PromptTemplate总结](./6.PromptTemplate总结) 和 [ChatPromptTemplate总结](./7.ChatPromptTemplate总结)\
...
> 📖 **详细内容**：在后续文档（6、7、8、9）的代码示例中都会出现 Predict 环节，尤其注意 `BaseChatModel` 与旧版 `BaseLLM` 返回值的差异，详见 [返回值类型总结](./8.返回值类型总结)。
